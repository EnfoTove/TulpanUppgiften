...
var TulipListWebPart = /** @class */ (function (_super) {
    ...
    TulipListWebPart.prototype._getListItems = function () {
        ...
        return this.context.spHttpClient.get(this.context.pageContext.web.absoluteUrl + ("/_api/web/lists/getbytitle('" + this.properties.listName + "')/items?$select= ID, Title, ManufacturingPrice, RetailPrice, TulipResponsible/Id, Author/Id&$expand=TulipResponsible/Id, Author/AuthorId"), SPHttpClient.configurations.v1)
            .then(function (response) {
    ...
    TulipListWebPart.prototype._deleteListItem = function (item) {
        ...
        return this.context.spHttpClient.get(this.context.pageContext.web.absoluteUrl + ("/_api/web/lists/getbytitle('" + this.properties.listName + "')/items(" + item.ID + ")?$select=Id"), SPHttpClient.configurations.v1)
            .then(function (response) {
            return response.json();
        })
            .then(function (jsonResponse) {
