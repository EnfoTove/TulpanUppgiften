...
export var PropertyContext = React.createContext(undefined);
            ...
            return (React.createElement("div", { className: styles.tulipList },
                React.createElement("div", { className: styles.container },
                    ...
                    this.state.showAddItemForm ?
                        React.createElement(PropertyContext.Provider, { value: this.state },
                            React.createElement(AddItemForm, { context: this.props.context, listName: this.props.listName, hideComponent: this._closeAddItemForm }))
                        : null,
