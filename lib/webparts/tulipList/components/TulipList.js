...
var TulipList = /** @class */ (function (_super) {
    ...
    TulipList.prototype._getAddItemForm = function () {
        return (React.createElement("form", null,
            ...
            React.createElement(PeoplePicker, { context: this.props.context, ensureUser: true, groupName: 'EnfokamTulipsTove', webAbsoluteUrl: TulipList.siteURL, onChange: this._getPeoplePickerItems.bind(this) }),
