...
import { DefaultButton, Spinner, SpinnerSize, PrimaryButton, DialogContent, DialogFooter, Icon, TextField } from 'office-ui-fabric-react';
...
var TulipList = /** @class */ (function (_super) {
                            ...
                            this.state.listItems && this.state.listItems.map(function (item, index) {
                                return React.createElement("tbody", null,
                                    React.createElement("tr", { key: item.ID },
                                        ...
                                        _this._testing(item).serverRelativeUrl,
    ...
    TulipList.prototype._testing = function (item) {
    ...
    TulipList.prototype._checkIfNumber = function (value) {
        return /^\d*?\.?\d+$/.test(value);
    };
    TulipList.prototype._checkIfNullOrEmpty = function (value) {
        var isNullOrEmpty;
    ...
    TulipList.prototype._addNewItem = function () {
        return __awaiter(this, void 0, void 0, function () {
            var noTitle, nonNumericMP;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        noTitle = this._checkIfNullOrEmpty(this.state.newTulipName);
                        noTitle ? this.setState({ nullTitlePost: true }) : this.setState({ nullTitlePost: false });
                        nonNumericMP = !this._checkIfNumber(this.state.newTulipManufacturingPrice) && this.state.newTulipManufacturingPrice != null;
                        ...
                        if (!(!noTitle && !nonNumericMP)) return [3 /*break*/, 4];
                        console.log(this.state.nullTitlePost);
                        console.log("Posting this: " + this.state.newTulipName);
                        if (!(this.state.newTulipResponsible != null)) return [3 /*break*/, 2];
                        return [4 /*yield*/, sp.web.lists.getByTitle(this.props.listName).items.add({
                    ...
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, sp.web.lists.getByTitle(this.props.listName).items.add({
                            Title: this.state.newTulipName,
                            ManufacturingPrice: this.state.newTulipManufacturingPrice,
                        }).then(this.setState({
                            newTulipName: "",
        ...
        return (React.createElement("div", { className: styles.addItemForm },
            ...
            React.createElement("form", null,
                this.state.nullTitlePost ?
                    React.createElement(TextField, { label: "Title", required: true, name: "newTulipName", value: this.state.newTulipName, onChange: this._handleChange, errorMessage: "Please enter a title" })
                    : React.createElement(TextField, { label: "Title", required: true, name: "newTulipName", value: this.state.newTulipName, onChange: this._handleChange }),
                this.state.nonNumericPost ?
                    React.createElement(TextField, { label: "Manufacturing price", name: "newTulipManufacturingPrice", value: this.state.newTulipManufacturingPrice, onChange: this._handleChange, errorMessage: "Please enter a valid number" })
                    : React.createElement(TextField, { label: "Manufacturing price", name: "newTulipManufacturingPrice", value: this.state.newTulipManufacturingPrice, onChange: this._handleChange }),
                React.createElement(PeoplePicker, { context: this.props.context, personSelectionLimit: 1, titleText: 'Tulip responsible:', ensureUser: true, groupName: 'EnfokamTulipsTove', webAbsoluteUrl: TulipList.siteURL, onChange: this._getPeoplePickerItems.bind(this) }),
    ...
    TulipList.prototype._delayBlocking = function (milliseconds) {
    ...
    TulipList.prototype._checkValues = function () {
        if (this._checkIfNullOrEmpty(this.state.newTulipName)) {
            console.log("no title");
            this.setState({
                nullTitlePost: true
