...
var TulipList = /** @class */ (function (_super) {
    ...
    TulipList.prototype._getImgUrl = function (item) {
        try {
            var imageObj = JSON.parse(JSON.stringify(item.Image));
            var key1 = imageObj.replace("'fileName'", '"fileName"');
            var key2 = key1.replace("'serverRelativeUrl'", '"serverRelativeUrl"');
            var key3 = key2.replace("'serverUrl'", '"serverUrl"');
            var key4 = key3.replace("'/sites/EnfokamTulipsTove/SiteAssets/Lists/8740d2c9-ba96-4ade-ab01-cbe3a336cfbd/bluetulip.jfif'", '"/sites/EnfokamTulipsTove/SiteAssets/Lists/8740d2c9-ba96-4ade-ab01-cbe3a336cfbd/bluetulip.jfif"');
            var key5 = key4.replace("'/sites/EnfokamTulipsTove/SiteAssets/Lists/8740d2c9-ba96-4ade-ab01-cbe3a336cfbd/yellowtulip.jfif'", '"/sites/EnfokamTulipsTove/SiteAssets/Lists/8740d2c9-ba96-4ade-ab01-cbe3a336cfbd/yellowtulip.jfif"');
            var key6 = key5.replace("'/sites/EnfokamTulipsTove/SiteAssets/Lists/8740d2c9-ba96-4ade-ab01-cbe3a336cfbd/redtulip.jfif'", '"/sites/EnfokamTulipsTove/SiteAssets/Lists/8740d2c9-ba96-4ade-ab01-cbe3a336cfbd/redtulip.jfif"');
            var key7 = key6.replace("'/sites/EnfokamTulipsTove/SiteAssets/Lists/8740d2c9-ba96-4ade-ab01-cbe3a336cfbd/blacktulip.jfif'", '"/sites/EnfokamTulipsTove/SiteAssets/Lists/8740d2c9-ba96-4ade-ab01-cbe3a336cfbd/blacktulip.jfif"');
            var key8 = key7.replace("'/sites/EnfokamTulipsTove/SiteAssets/Lists/8740d2c9-ba96-4ade-ab01-cbe3a336cfbd/whitetulip.jfif'", '"/sites/EnfokamTulipsTove/SiteAssets/Lists/8740d2c9-ba96-4ade-ab01-cbe3a336cfbd/whitetulip.jfif"');
            var key9 = key8.replace("'https://wcqvp.sharepoint.com'", '"https://wcqvp.sharepoint.com"');
            var key10 = key9.replace("'redtulip.jfif'", '"redtulip.jfif"');
            var key11 = key10.replace("'bluetulip.jfif'", '"bluetulip.jfif"');
            var key12 = key11.replace("'yellowtulip.jfif'", '"yellowtulip.jfif"');
            var key13 = key12.replace("'whitetulip.jfif'", '"whitetulip.jfif"');
            var key14 = key13.replace("'blacktulip.jfif'", '"blacktulip.jfif"');
            console.log("IMG OBJ BF PARSE" + key14);
            var jsonObject = JSON.parse(key14);
