...
import { DefaultButton, Spinner, SpinnerSize, PrimaryButton } from 'office-ui-fabric-react';
...
var TulipList = /** @class */ (function (_super) {
            ...
            return (React.createElement("div", { className: styles.tulipList },
                React.createElement("div", { className: styles.container },
                    ...
                    this.state.showDeleteBox ?
                        React.createElement(DialogContent, { className: styles.deleteBox, title: 'Delete?', subText: "Do you really want to delete this item?", onDismiss: function () { return _this._closeDialog(); }, showCloseButton: true },
                            React.createElement(DialogFooter, null,
                                React.createElement(DefaultButton, { text: 'Cancel', title: 'Cancel', onClick: function () { return _this._closeDialog(); } }),
    ...
    TulipList.prototype._closeDialog = function () {
        this.setState({
            showDeleteBox: false
        });
    };
